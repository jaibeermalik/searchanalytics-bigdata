...
/**
 * Exception thrown in case of issues generating the products etc. data which
 * needs to be indexed.
 * 
 * @author malikj
 * 
...
public class DocumentTypeDataGenerationException extends Exception {
	...
	public DocumentTypeDataGenerationException(
			final IndexDocumentType indexDocumentType, final String s,
