...
public enum ElasticSearchIndexConfig {
	COM_WEBSITE("com", IndexDocumentType.PRODUCT.getText(),
			SupportedLocale.ENGLISH), NL_WEBSITE("nl",
			IndexDocumentType.PRODUCT.getText(), SupportedLocale.DUTCH);
	...
	private ElasticSearchIndexConfig(final String indexName,
			final String documentType, final SupportedLocale supportedLocale) {
	...
	public static enum SupportedLocale {
		ENGLISH("en_EN", "English"), DUTCH("nl_NL", "Dutch");
		private String text;
