...
public class IndexSchemaBuilder
{
    ...
    public Settings getSettingForIndex(final ElasticSearchIndexConfig config) throws IOException
    {
        ...
        final Settings settings = settingsBuilder().loadFromSource(
                jsonBuilder()
                        ...
                        .field(ElasticSearchReservedWords.STOPWORDS_PATH.getText(),
                                "stopwords/stop_" + config.getSupportedLocale().getText())
                        .endObject()
                        ...
                        .field(ElasticSearchReservedWords.PROTECTED_WORDS_PATH.getText(),
                                "worddelimiters/protectedwords_" + config.getSupportedLocale().getText())
                        ...
                        .field(ElasticSearchReservedWords.SYNONYMS_PATH.getText(),
                                "synonyms/synonyms_" + config.getSupportedLocale().getText())
                        ...
                        .field(ElasticSearchReservedWords.FILTER.getText(),
                                new String[] { ElasticSearchReservedWords.LOWERCASE.getText(), config.getStopwordsCustomFilterName(),
                                        config.getSynonymsCustomFilterName(), config.getSnowballCustomFilterName() })
                        .endObject()
                        ...
                        .field(ElasticSearchReservedWords.FILTER.getText(),
                                new String[] { ElasticSearchReservedWords.LOWERCASE.getText(), config.getWorddelimiterCustomFilterName(),
                                        config.getStopwordsCustomFilterName(), config.getSynonymsCustomFilterName(),
                        ...
                        .field(ElasticSearchReservedWords.TOKENIZER.getText(), ElasticSearchReservedWords.STANDARD.getText())
                        .field(ElasticSearchReservedWords.FILTER.getText(),
                                new String[] { ElasticSearchReservedWords.LOWERCASE.getText(), config.getSnowballCustomFilterName(),
                                        config.getSynonymsCustomFilterName() }).endObject().endObject().endObject().endObject().string())
                .build();
        logger.debug("Generated settings for index {} is: {}", new Object[] { config.getIndexAliasName(), settings.getAsMap() });
        return settings;
    }

    public XContentBuilder getDocumentTypeMapping(final ElasticSearchIndexConfig elasticSearchIndexConfig, final String documentType,
    ...
    private void addSpecifications(final XContentBuilder builder, final ElasticSearchIndexConfig elasticSearchIndexConfig)
            throws IOException
    {
        builder.startObject(SearchDocumentFieldName.SPECIFICATIONS.getFieldName())
                ...
                .field(ElasticSearchReservedWords.STORE.getText(), ElasticSearchReservedWords.YES.getText()).endObject()
                .startObject(SearchDocumentFieldName.MEMORY.getFieldName())
                .field(ElasticSearchReservedWords.TYPE.getText(), ElasticSearchReservedWords.STRING.getText())
                .field(ElasticSearchReservedWords.INDEX.getText(), ElasticSearchReservedWords.NOT_ANALYZED.getText())
                .field(ElasticSearchReservedWords.STORE.getText(), ElasticSearchReservedWords.YES.getText()).endObject().endObject()
                .field(ElasticSearchReservedWords.TYPE.getText(), ElasticSearchReservedWords.NESTED.getText()).endObject();
    }

    private void addProductBooleanFieldMappingForNEW(final XContentBuilder builder) throws IOException
    {
        // standard fields
    ...
    private void addLiveDateMapping(final XContentBuilder builder) throws IOException
    {
    ...
    private void addCustomBoostFactorMapping(final XContentBuilder builder) throws IOException
    {
    ...
    private void addProductDynamicValues(final XContentBuilder builder) throws IOException
    {
    ...
    private XContentBuilder addContentInformationFieldsMapping(final XContentBuilder builder,
            final ElasticSearchIndexConfig elasticSearchIndexConfig) throws IOException
    {
        // content information fields
        builder.startObject(SearchDocumentFieldName.TITLE.getFieldName())
                .field(ElasticSearchReservedWords.TYPE.getText(), ElasticSearchReservedWords.STRING.getText())
                .field(ElasticSearchReservedWords.STORE.getText(), ElasticSearchReservedWords.YES.getText())
                .field(ElasticSearchReservedWords.ANALYZER.getText(), elasticSearchIndexConfig.getCustomFreeTextAnalyzerName()).endObject()
        ...
        {
            final int hierarchyLevel = SearchFacetName.getSupportedFacetParentChildHierarchyLevel();
