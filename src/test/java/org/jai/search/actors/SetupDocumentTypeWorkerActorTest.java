...
public class SetupDocumentTypeWorkerActorTest {
	...
	public void handleChildActorsException() {
		...
		DocumentTypeDataGenerationException documentTypeDataGenerationException = new DocumentTypeDataGenerationException(
				documentType, "Testing", new RuntimeException());
		...
		ref.tell(documentTypeDataGenerationException,
				testProbeDataGeneratorWorker.ref());
		...
		DocumentGenerationException documentGenerationException = new DocumentGenerationException(
				"Error generation document!");
		ref.tell(documentGenerationException,
				testProbeDocumentGeneratorWorker.ref());

		// Updated actor state, decreases doc count by 1. and state reset as all
		// is done.
		assertEquals(0, actor.getTotalDocumentsToIndex());
		assertEquals(0, actor.getTotalDocumentsToIndexDone());
		assertEquals(null, actor.getIndexDocumentType());
		...
		IndexDocumentType testProbeParentActorMessageType2 = (IndexDocumentType) testProbeParentActorMessage
				.msg();
		...
		IndexDataException indexDataException = new IndexDataException(
		...
		testProbeParentActor.expectMsgClass(IndexDocumentType.class);
		testProbeParentActorMessage = testProbeParentActor.lastMessage();
		IndexDocumentType testProbeParentActorMessageType3 = (IndexDocumentType) testProbeParentActorMessage
				.msg();
		...
		testProbeParentActor.expectMsgClass(IndexDocumentType.class);
		testProbeParentActorMessage = testProbeParentActor.lastMessage();
		IndexDocumentType testProbeParentActorMessageType4 = (IndexDocumentType) testProbeParentActorMessage
				.msg();
